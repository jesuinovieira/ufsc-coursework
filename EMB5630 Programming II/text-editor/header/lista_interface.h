...
/*
 * Função: insere um elemento na cabeca da lista.
 * Pré: a lista deve existir e o elemento deve ser válido.
 * Pós: o elemento é inserido na cabeca da lista.
 */
void insereCabeca(lista_t *l, const void *elem);

/*
 * Função: insere um elemento na cauda da lista.
 * Pré: a lista deve existir e o elemento deve ser válido.
 * Pós: o elemento é inserido na cabeca da lista.
 */
